-- Make click-ad optional + add notice_slides setting
...
-- Reset all user points (preserves total_earned)
...
DECLARE n bigint;
BEGIN
  UPDATE public.app_users SET points = 0, pending_points = 0, cycle_ads = 0;
